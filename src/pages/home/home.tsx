...
export default function Home() {
    ...
    const modalContent = {
        ...
        content: <p>Are you sure you want to add you new
            employee <strong>{newEmployee?.firstName} {newEmployee?.lastName}</strong> to the list of employees ?</p>,
    };
        ...
        <>
            ...
            <div className={'container'}>
                ...
                <form onSubmit={handleSubmit} ref={formRef} id="create-employee" className={'form'}>
                    ...
                    <span
                        className={`input-error ${!isFormValid.isValid ? 'fade-in' : ''}`}>{isFormValid.message}</span>
                </form>
            </div>
            {isModalOpen &&
                createPortal(
